...
const AddTodo = (props: Props) => {
	...
	className={` ${
		errors.todo && touched.todo
			? `rounded-lg p-3 placeholder:text-white/50 text-white block w-full shadow-sm focus:outline-none focus:border-red-600 border-2 bg-transparent border-red-600 transition-all`
			: ``
	} rounded-lg p-3 lg:mr-5 placeholder:text-white/50 text-white block py-1.5 w-full
  shadow-sm focus:outline-none border-2 bg-transparent border-gray-600
   focus:border-blue-600 transition-all col-span-3 lg:col-span-2 row-span-1`}
	type="text"
	name="todo"
